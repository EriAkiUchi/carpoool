...
const rotas: RouteRecordRaw[] = [
  ...
  {
    path: '/passageiro/viagens',
    name: 'passageiro-viagens',
    component: () => import('../views/Passageiro/ViagensPassageiro.vue'),
    meta: { requiresAuth: true, role: 'passageiro' }
  },
  {
    path: '/motorista',
  ...
  {
    path: '/motorista/anunciar-carona',
